...
class EditContent extends StatefulWidget {
  final String imageUrl, credits, timestamp, category;
  final int loves;
  ...
  _EditContentState createState() => _EditContentState(
      this.imageUrl, this.credits, this.timestamp, this.loves, this.category);
}
...
class _EditContentState extends State<EditContent> {
  ...
  var creditsCtrl = TextEditingController();
              ...
              children: <Widget>[
                ...
                TextFormField(
                  decoration: inputDecoration(
                      'Enter Author Name', 'Image', creditsCtrl),
